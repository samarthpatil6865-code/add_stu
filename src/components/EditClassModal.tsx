...
const EditClassModal = ({ open, onOpenChange, classData }: EditClassModalProps) => {
  const { updateClass, classes } = useStudents();
  ...
  const onSubmit = (data: ClassFormData) => {
    ...
    const nameExists = classes.some(c => c.name === data.name && c.id !== classData.id);
    if (nameExists) {
      toast({
